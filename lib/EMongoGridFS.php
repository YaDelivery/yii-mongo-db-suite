...
abstract class EMongoGridFS extends EMongoDocument
{
  ...
  public function insert(array $attributes = null)
  {
    if (!$this->getIsNewRecord())
    {
      throw new EMongoException(Yii::t(
                                  'yii',
                                  'The EMongoDocument cannot be inserted to the database because it is not new.'
                                ));
    }
  ...
  public function insertWithPk($pk, array $attributes = null)
  {
    if (!($pk instanceof MongoId))
    {
      throw new EMongoException(Yii::t(
                                  'yii',
                                  'The EMongoDocument cannot be inserted to the database beacuse its primary key is not defined.'
                                ));
    }
