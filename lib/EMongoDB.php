...
class EMongoDB extends CApplicationComponent
{
  ...
  /**
   * @var int connectTimeoutMS For how long the driver should try to connect to the database (in milliseconds).
   * @example 2000
   * @since   v1.4.1
   */
  public $connectTimeoutMS = 2000;
  ...
  public function getConnection()
  {
    if ($this->_mongoConnection === null)
    {
      try
      {
        ...
        if (!is_null($this->connectTimeoutMS))
        {
